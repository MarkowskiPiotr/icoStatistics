...
ticketProjects = ['CORINT', 'IGW4000', "'MLGTINT', 'MLGTFON'", "'MLLTINT', 'MLLTFON'", "'I520XTQA', 'I520XTW'", 'SPYDINT', 'I488271INT' ]
...
for filterProject in ticketProjects:
    ...
    for filterDateIterator in (filterDates):
        ...
        projectsStatistics[filterProject][str(filterDateIterator)] = getFiltersResults.generateStatistics(filterProject, ticketStatuses,
                                                                                 ticketPriority,
                                                                                 filterDateIterator.strftime('%Y/%m/%d'),
                                                                                 previousDay.strftime('%Y/%m/%d'))
